...
db = PostgresqlDatabase("", user="yuntuna", password="", host="localhost", port=5432)
...
Note(title="Grocery List", content="Cereal, Bagel, Bread, Flour, Sugar").save()

Note(title="To Do", content="Clean, Car, Soak, Dishes").save()

Note(title="Reminders", content="Job Int, Oil Change, Pay Bills").save()

Note(title="Places to Visit", content="New York, Rome, Tokyo, London, Vermont").save()
